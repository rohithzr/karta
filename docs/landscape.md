...
|---|---|---|---|
| **MemOS** *(MemTensor)* | AI memory OS for LLM agents; persistent skill memory, cross-task reuse, hybrid FTS5+vector search; OpenClaw Cloud + Local plugins (Mar 2026); Reflect2Evolve architecture (v2.0.14+); hook-based plugin system for extensible memory processing | Active, open-source, v2.0.15 (May 2026) | [github.com/MemTensor/MemOS](https://github.com/MemTensor/MemOS) |
