...
| **Honcho** | 63.0% (100K) / 40.9% (10M, evals.honcho.dev) | 89.9% *(LLM-judge)* | 90.4% *(LongMem-S, self-published evals.honcho.dev, May 2026)* | Peer Representations per user/agent; formal logic-based; v3 architecture | Dialectic agentic loop over full history | Agentic loop — full history re-processing per query; external vector store option (v3.0.4) | Yes — async dreaming: deduction, induction, abduction, summaries, peer cards | Not exposed | Not documented | Not documented | Low — dreaming chain-of-thought is opaque | Python; hosted API ($2/M tokens ingested); MCP server (v3); self-hosting now provider-agnostic (any OpenAI-compatible endpoint); evals.honcho.dev publishes full benchmark artifacts | Medium-high — dreaming charged separately |
| **EverOS** *(formerly EverMemOS; EverMind-AI)* | — | 93.05% *(self-published, Feb 2026 product release; beats full-context; +19.7% multi-hop, +16.1% temporal vs prior SOTA)* | 83.00% | Engram lifecycle: encode → consolidate → forget; event-boundary segmentation; Skills Evolution Engine (Apr 2026): learns reusable skills from agent trajectories | Event-boundary segmentation at write time | Dual-mode: fast embed + multi-hop agentic reasoning; mRAG hybrid retrieval (multimodal: PDFs, images, docs, URLs) | Yes — consolidation, lifecycle transitions, active forgetting | Yes — core design principle; intelligent attention filter | Yes — MemCell event-boundary segmentation is their core innovation | Not documented | Low — HTTP service, internals opaque | Python + Docker; REST API; EverOS Cloud (formerly EverMemOS Cloud); GitHub: EverMind-AI/EverOS (renamed Apr 14, 2026) | High — separate service with own infra; Cloud option reduces ops |
...
| **Mem0** | — | v3: 92.5% *(self-published, mem0.ai/research, Apr 2026; single-pass extraction + multi-signal retrieval; ~7K tokens/query)*; paper: 66.9% *(arxiv 2504.19413; Mem0g graph variant: 68.4%)* | v3: 94.4% *(self-published, mem0.ai/research, Apr 2026)* | Single-pass hierarchical fact extraction; graph variant (Mem0g) builds directed labeled KG alongside vector store; v3 adds agent-generated facts as first-class | Single-pass extraction → deduplication; v3: treats agent-generated facts equally alongside conversation-extracted facts | Multi-signal retrieval: semantic similarity + keyword + entity matching (3 parallel passes); Mem0g adds graph traversal; reranker support (Cohere, ZeroEntropy, HF, Sentence Transformers, LLM-based) | None | Manual or TTL | None | None | High — simple API, no hidden logic | Python SDK v2.0.11 (Jul 1 2026); REST API; OpenCode plugin; Pi Agent Plugin (guaranteed pre-fetch before agent execution) | Low — hosted API |
...
| **ByteRover** | — | 96.1% *(v2.1.5, self-published Mar 2026)* | 92.8% *(v2.1.5, self-published Mar 2026)* | Context Tree — hierarchical knowledge organized by domain/topic/subtopic before query time | Conversational context curated into Context Tree hierarchy at write time; git-like versioning | Context Tree traversal + semantic; 6 retrieval signals (semantic, lexical, activation, graph, importance, temporal); p50 latency 1.6s | Not documented | Not documented | Not documented | Not documented | Medium — Context Tree inspectable via web dashboard | TypeScript; SQLite; local-first; MCP integration; 22+ AI tool integrations; open-source (Elastic License 2.0) | Low — local-first, no cloud required; optional cloud sync |
...
| **SimpleMem: Efficient Lifelong Memory for LLM Agents** *(arxiv 2601.02553, Jan 2026)* | 3-stage pipeline: semantic lossless compression → online synthesis → intent-aware retrieval; 30× fewer tokens than full-context; multimodal support (text/image/audio/video); MIT-licensed Python library | LoCoMo F1: 43.24 (SimpleMem, GPT-4.1-mini); outperforms Mem0 F1 34.20 by 26.4% | [arxiv 2601.02553](https://arxiv.org/abs/2601.02553) |
| **EvolveMem: Self-Evolving Memory Architecture via AutoResearch** *(arxiv 2605.13941, May 2026)* | Follow-up to SimpleMem; closed-loop LLM diagnosis autonomously discovers new retrieval dimensions without human engineering; "AutoResearch" meta-learning loop | LoCoMo F1: 0.543 (GPT-4o, +25.7% over SimpleMem); MemBench: 67.9% (+18.9%) | [arxiv 2605.13941](https://arxiv.org/html/2605.13941) |
| **"From Storage to Experience": Survey on Evolution of LLM Agent Memory Mechanisms** *(arxiv 2605.06716, May 2026)* | Proposes 3-stage evolutionary framework: Storage (trajectory preservation) → Reflection (trajectory refinement) → Experience (trajectory abstraction); bridges engineering and cognitive science perspectives | — survey | [arxiv 2605.06716](https://arxiv.org/abs/2605.06716) |
| **Mnemonic Sovereignty: Security of Long-Term Memory in LLM Agents** *(arxiv 2604.16548, Apr 2026)* | First security survey for LLM agent memory; lifecycle framework: Write/Store/Retrieve/Execute/Share/Forget/Rollback; identifies write/retrieve integrity as most-studied, confidentiality/availability/governance as under-studied | — survey | [arxiv 2604.16548](https://arxiv.org/abs/2604.16548) |
| **Eywa: Provenance-Grounded Long-Term Memory for AI Agents** *(arxiv 2605.30771, May 2026)* | Evidence-before-belief architecture; immutable source evidence stored before fact derivation; zero LLM calls in retrieval; separates source, extraction, retrieval, and answer layers for diagnosability | LoCoMo C1-C4: 90.19%; LongMemEval-S: 88.2%; BEAM (700q): 81.45% mean nugget | [arxiv 2605.30771](https://arxiv.org/abs/2605.30771), [eywa.to](https://eywa.to) |
| **LongMemEval-V2** *(arxiv 2605.12493, May 2026)* | New benchmark for web-agent memory specifically; 451 manually curated questions across 5 abilities: static state recall, dynamic state tracking, workflow knowledge, environment gotchas, premise awareness; up to 500 trajectories spanning 115M tokens | AgentRunbook-C: 72.5%; AgentRunbook-R: 48.5% | [arxiv 2605.12493](https://arxiv.org/abs/2605.12493) |
| **Portable Agent Memory Protocol** *(arxiv 2605.11032, May 2026)* | Protocol for cryptographically-verified memory transfer across heterogeneous AI agents; addresses memory portability and provenance | — | [arxiv 2605.11032](https://arxiv.org/abs/2605.11032) |
| **Are We Ready For An Agent-Native Memory System?** *(arxiv 2606.24775, Jun 2026)* | Comprehensive evaluation of 12 memory systems across 11 datasets, 5 benchmark workloads; 4-module decomposition: representation/storage, extraction, retrieval/routing, maintenance; key finding: no universal winner, workload alignment determines effectiveness; localized maintenance cheaper than global reorganization | — evaluation | [arxiv 2606.24775](https://arxiv.org/abs/2606.24775) |
...
| **EverOS** *(EverMind-AI; formerly EverMemOS)* | Renamed from EverMemOS on Apr 14, 2026; Skills Evolution Engine (234.8% relative task success gain via trajectory→skill distillation); mRAG multimodal hybrid retrieval (PDFs/images/docs/URLs); HyperMem hypergraph architecture (ACL 2026); global public beta Apr 2026 | Active, open-source + Cloud | [github.com/EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS), [prnewswire.com](https://www.prnewswire.com/news-releases/the-awakening-moment-for-agents-everos-brand-upgrade-and-public-beta-launches-the-era-of-self-evolving-memory-302741954.html) |
...
| **Eywa** *(Resham Joshi)* | Provenance-grounded long-term memory — stores immutable source evidence before deriving canonical facts; zero LLM calls inside retrieval path; deterministic multi-route read; LoCoMo C1-C4 90.19% (Claude Sonnet 4.6), LongMemEval-S 88.2% retrieval-sufficiency, BEAM 81.45% mean nugget score; artifacts publicly recorded | Research, open-source, May 2026 | [eywa.to](https://eywa.to), [arxiv 2605.30771](https://arxiv.org/abs/2605.30771) |
...
| **SimpleMem / EvolveMem** *(aiming-lab)* | Research memory framework: semantic lossless compression, 30× fewer tokens vs full-context; multimodal support (text/image/audio/video); MCP integration; EvolveMem v3.0 (May 2026) self-evolves retrieval dimensions via AutoResearch closed-loop LLM diagnosis; LoCoMo F1 43.24 (SimpleMem) → 54.3 (EvolveMem) | Active, v0.2.0 (Apr 2026), Python, MIT | [arxiv 2601.02553](https://arxiv.org/abs/2601.02553), [arxiv 2605.13941](https://arxiv.org/html/2605.13941), [github.com/aiming-lab/SimpleMem](https://github.com/aiming-lab/SimpleMem) |
...
| 2026-05-18 | **Fixed Memori/MemPalace row formatting bug**: Memori row was missing 10 of 14 columns; the missing columns were incorrectly appended to the end of the MemPalace row. Both rows now correctly have all 14 columns. | Internal |
| 2026-05-18 | **Added ByteRover to competitive matrix and notable systems** — Context Tree architecture; LoCoMo 96.1%, LongMemEval-S 92.8% (v2.1.5, self-published Mar 2026); TypeScript CLI, 4.8k GitHub stars, v3.14.0 (May 18 2026), Elastic License 2.0, formerly Cipher | [byterover.dev/blog](https://www.byterover.dev/blog/benchmark_ai_agent_memory_real_production_byterover_top_market_accuracy_longmemeval), [github.com/campfirein/byterover-cli](https://github.com/campfirein/byterover-cli) |
| 2026-05-18 | **Added SimpleMem/EvolveMem to notable systems and papers table** — SimpleMem (arxiv 2601.02553, Jan 2026): 30× fewer tokens, multimodal, LoCoMo F1 43.24; EvolveMem v3.0 (arxiv 2605.13941, May 2026): self-evolving retrieval via AutoResearch, LoCoMo F1 54.3 | [arxiv 2601.02553](https://arxiv.org/abs/2601.02553), [arxiv 2605.13941](https://arxiv.org/html/2605.13941) |
| 2026-05-18 | **Added 2 new survey papers**: "From Storage to Experience" (arxiv 2605.06716, May 2026) — 3-stage memory evolution framework (Storage→Reflection→Experience); "Mnemonic Sovereignty" (arxiv 2604.16548, Apr 2026) — first security lifecycle survey for LLM agent memory | [arxiv 2605.06716](https://arxiv.org/abs/2605.06716), [arxiv 2604.16548](https://arxiv.org/abs/2604.16548) |
| 2026-05-18 | **MemOS v2.0.15 released** (May 11, 2026) — hook-based plugin system for extensible memory processing; Reflect2Evolve architecture in memos-local-plugin (v2.0.14, Apr 23) | [github.com/MemTensor/MemOS/releases](https://github.com/MemTensor/MemOS/releases) |
| 2026-05-18 | **Hindsight v0.6.2 released** (May 14, 2026) — bugfix: timestamp not reaching retain API; openclaw v0.7.7, claude-code v0.6.5 integration releases (May 15) | [github.com/vectorize-io/hindsight](https://github.com/vectorize-io/hindsight/commits/main) |
| 2026-05-18 | **Letta v0.16.8 released** (May 14, 2026) — security fix: JSON instead of pickle for sandbox→server tool result transport | [github.com/letta-ai/letta/releases](https://github.com/letta-ai/letta/releases) |
| 2026-05-18 | Honcho active development (Apr–May 2026): embeddings configurable (#678), deriver custom instructions (#609), dialectic N+1 query fix (#652), model-aware tokenizer (#647); no new release tag | [github.com/plastic-labs/honcho](https://github.com/plastic-labs/honcho/commits/main) |
| 2026-05-18 | Mem0 May 2026: Agent Mode bootstrap + claim flow CLI (May 14); TypeScript latestOnly on hosted memory reads; hosted Qdrant migration script; SOC2/GDPR unverified claims removed from docs | [github.com/mem0ai/mem0](https://github.com/mem0ai/mem0/commits/main) |
| 2026-05-18 | Memori v0.1.5 (May 15, 2026): Hermes integration skill file (#499), improved MCP docs, OpenAI multimodal array parsing fix, recall filter hardening | [github.com/MemoriLabs/Memori](https://github.com/MemoriLabs/Memori/commits/main) |
| 2026-07-04 | **EverMemOS officially renamed EverOS** (Apr 14, 2026 brand upgrade + global public beta). New GitHub: EverMind-AI/EverOS. New features: Skills Evolution Engine (234.8% relative task success gain on SWE-bench variant), mRAG multimodal hybrid retrieval, HyperMem hypergraph architecture (ACL 2026). Updated matrix row and notable systems entry to reflect rename. | [prnewswire.com](https://www.prnewswire.com/news-releases/the-awakening-moment-for-agents-everos-brand-upgrade-and-public-beta-launches-the-era-of-self-evolving-memory-302741954.html), [github.com/EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) |
| 2026-07-04 | **Honcho LongMemEval-S updated 88.8% (LongMem-M) → 90.4% (LongMem-S)** per evals.honcho.dev (self-published, May 2026). BEAM 10M corrected from "SOTA" to 40.9% (0.409); Hindsight holds 10M SOTA at 64.1%. New BEAM tiers now visible on honcho.dev: 500K 64.6%, 1M 61.8%, 10M 40.9%. | [honcho.dev](https://honcho.dev), [evals.honcho.dev](https://evals.honcho.dev) |
| 2026-07-04 | **Mem0 v3 algorithm** (self-published, mem0.ai/research, Apr 2026): LoCoMo 92.5%, LongMemEval 94.4%, BEAM 1M 64.1%, BEAM 10M 48.6% — all at ~7K tokens/query vs 25K+ for full-context. Single-pass extraction + 3-parallel multi-signal retrieval (semantic + keyword + entity). Updated matrix row. Note: these are self-published by Mem0, not from the arxiv paper (which reports 66.9%/68.4%). | [mem0.ai/research](https://mem0.ai/research) |
| 2026-07-04 | **Mem0 releases** — SDK v2.0.11 (Jul 1, 2026): Pi Agent Plugin (pre-fetches memories before agent execution), OpenCode Plugin v0.2.1, security hardening (injection protection in vector store filter values), MiniMax + LiteLLM provider support, expiration date capability | [github.com/mem0ai/mem0/releases](https://github.com/mem0ai/mem0/releases) |
| 2026-07-04 | **MemOS v2.0.22 released** (Jul 3, 2026); LoCoMo 92.34%, LongMemEval 93.40% (self-published, GitHub README); leads OmniMemEval among 14 commercial memory products (10 datasets); memos-local-plugin 2.0 (May 2026): L1 traces/L2 policies/L3 world models/crystallized Skills hierarchy; OpenClaw task completion improved 36.63% → 50.87% across 5 agent tasks | [github.com/MemTensor/MemOS/releases](https://github.com/MemTensor/MemOS/releases) |
| 2026-07-04 | **Added Eywa to notable systems and papers table** — provenance-grounded memory; immutable evidence-before-belief design; zero LLM calls in retrieval; LoCoMo C1-C4 90.19%, LongMemEval-S 88.2%, BEAM 81.45% (May 2026, self-published) | [arxiv 2605.30771](https://arxiv.org/abs/2605.30771), [eywa.to](https://eywa.to) |
| 2026-07-04 | **Added 4 new papers**: LongMemEval-V2 (arxiv 2605.12493, May 2026 — web-agent memory benchmark, 451 questions, 115M token trajectories); Portable Agent Memory Protocol (arxiv 2605.11032, May 2026 — cryptographically-verified cross-agent memory transfer); "Are We Ready For An Agent-Native Memory System?" (arxiv 2606.24775, Jun 2026 — 12-system evaluation across 11 datasets, no universal winner); Eywa paper (arxiv 2605.30771, May 2026) | arxiv |
